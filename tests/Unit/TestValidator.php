...
use PauloRLima\BrazilianValidationsValidator;

class TestValidator extends Orchestra\Testbench\TestCase
{
    protected function getPackageProviders($app)
    {
        return [PauloRLima\BrazilianValidations\ValidatorProvider::class];
    }
    ...
    public function testCnpj()
    {
        ...
        // Correção do ISSUE: https://github.com/LaravelLegends/brazilian-validations/issues/4
